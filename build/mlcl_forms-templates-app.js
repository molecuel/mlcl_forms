...
angular.module("plugins/field_date/field_date.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("plugins/field_date/field_date.tpl.html",
    ...
    "  <label class=\"col-md-2 control-label\" for=\"{{attributes.name}}\">{{fieldInfo.label}}</label>\n" +
    "  <div class=\"col-md-10\">\n" +
    "    <date-time-zone defaulttimezone=\"defaultTZ\" tzmodel=\"tzmodel\" widgetmodel=\"model\" ></date-time-zone>\n" +
    "    <p class=\"help-block\">{{fieldInfo.help}}</p>\n" +
    "  </div>\n" +
    "</div>\n" +
    "");
...
angular.module("plugins/field_date/field_date_readonly.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("plugins/field_date/field_date_readonly.tpl.html",
    "<div class=\"form-group\">\n" +
    "  <label class=\"col-md-2 control-label\" for=\"{{attributes.name}}\">{{fieldInfo.label}}</label>\n" +
    "  <div class=\"col-md-10\">\n" +
    "    <input type=\"text\" class=\"form-control\" ng-model=\"model\" id=\"{{attributes.id}}\" name=\"{{attributes.name}}\" ng-required=\"{{attributes.required}}\" ng-readonly=\"true\" />\n" +
    "    <p class=\"help-block\">{{fieldInfo.help}}</p>\n" +
    "  </div>\n" +
    "</div>\n" +
    "");
