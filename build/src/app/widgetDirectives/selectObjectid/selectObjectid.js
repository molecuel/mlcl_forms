var mlcl_forms = angular.module('mlcl_forms').directive('selectObjectid', [
    '$http',
    'configService',
      ...
      return {
        ...
        link: function (scope) {
          ...
          scope.$watch('model', function (newVal) {
            if (newVal) {
              $http.get(configService.apiHost + '/api/search/' + scope.fieldinfo.ref + '/' + newVal).then(function (response) {
          ...
          scope.refreshObjects = function (searchString) {
            ...
            return $http.get(configService.apiHost + '/api/search/' + scope.fieldinfo.ref, { params: searchParam }).then(function (response) {
