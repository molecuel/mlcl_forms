...
///api/schema/' + $scope.modelName + ($scope.formName ? '/' + $scope.formName : ''
    ...
    $scope.createNew = function (dataToSave, options) {
      $http.post( $scope.apiHost + '/api/' + $scope.modelName, dataToSave).success(function (data) {
        if (data.success !== false) {
    ...
    $scope.updateDocument = function (dataToSave, options) {
      ...
      $http.post( $scope.apiHost + '/api/' + $scope.modelName + '/' + $scope.id, dataToSave).success(function (data) {
        if (data.success !== false) {
    ...
    $scope.newRecord = function newRecord() {
      $location.search('');
